...
vectorstore = PineconeVectorStore(api_key="YOUR_API_KEY", environment="YOUR_ENVIRONMENT")
# Add the embeddings to the PineconeVectorStore
vectorstore.add_documents(corpus_embeddings)
# Use the vectorstore as needed, e.g., with PineconeHybridSearchRetriever
# retriever = PineconeHybridSearchRetriever(index=index, vectorstore=vectorstore)  # Adjust as per actual usage
